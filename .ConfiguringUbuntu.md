...
* Turn on the [Steal my focus window](https://extensions.gnome.org/extension/6385/steal-my-focus-window/)
* [Only on 22.04] Prevent swap from being used as frequently by adding the following snippet to `/etc/sysctl.conf`
  ```
